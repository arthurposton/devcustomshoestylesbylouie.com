							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="right-block">
									<h5 class="h5product-name">
										<a class="product-name" href="{$product.link|escape:'html'}" title="{$product.name|truncate:35:'...'|escape:'htmlall':'UTF-8'}">{$product.name|truncate:25:'...'|escape:'htmlall':'UTF-8'}</a>
									</h5>
									<p>Elegant Clothing On Sale Only Today</p>
									 ...
									 {if isset($quick_view) && $quick_view}
										<div class="lab-quick-view">
											<a class="quick-view" href="{$product.link|escape:'html':'UTF-8'}"
												...
												<span>{l s='Quick view' mod='labspecialsproducts'}</span>
