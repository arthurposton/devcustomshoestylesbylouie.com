...
<div id="newsletter_block_left" class="footer-block">
	<h4>{l s='Join Our Newsletter' mod='blocknewsletter'}</h4>	
	<div class="toggle-footer">
		<p>{l s='Lorem ipsum dolor sit amete, consectetur adipisicing sed do eiusmod tempor incididunt ut labore etel dolore magna aliqua. Lorem ipsum dolor sit amete, consectetur ' mod='blocknewsletter'}</p>
