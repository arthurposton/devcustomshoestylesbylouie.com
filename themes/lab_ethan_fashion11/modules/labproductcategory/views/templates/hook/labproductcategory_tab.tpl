...
<div class="tab-content">
	...
	<div id="labProdCat-{$id}{$smarty.foreach.g_cat_info.index|intval}" class="tab-pane {if $smarty.foreach.g_cat_info.first} active{/if}">
		...
		<div class="product_list">
			...
			{if $use_slider == 1}
			<div class="lab_boxnp">
				<a class="prev prev{$type_display|escape:'html':'UTF-8'}{$id}{$smarty.foreach.g_cat_info.iteration}{$cat_info.id_cat|intval}"><i class="pe-7s-angle-left"></i></a>
				<a class="next next{$type_display|escape:'html':'UTF-8'}{$id}{$smarty.foreach.g_cat_info.iteration}{$cat_info.id_cat|intval}"><i class="pe-7s-angle-right"></i></a>
			</div> 
			{/if}
