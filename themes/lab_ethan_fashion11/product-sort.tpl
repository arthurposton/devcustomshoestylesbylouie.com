...
<ul class="display hidden-xs pull-left">
	<li class="display-title">{l s='View Style:'}</li>
    <li id="grid"><a rel="nofollow" href="javascript:void(0)" title="{l s='Grid'}"><i class="icon-th"></i></a></li>
    <li id="list"><a rel="nofollow" href="javascript:void(0)" title="{l s='List'}"><i class="icon-list"></i></a></li>
   <!--  <li id="column"><a rel="nofollow" href="javascript:void(0)" title="{l s='table'}"><i class="icon-table"></i></a></li> -->
</ul>
