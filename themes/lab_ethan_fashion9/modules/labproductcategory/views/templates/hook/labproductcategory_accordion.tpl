			 ...
			 <div class="block-content">
				<div id="labProdCat-{$cat_info.id_cat|intval}" class="row">
					...
					<div class="product_list">
						...
						{if $group_cat.use_slider == 1}
						<div class="lab_boxnp">
							<a class="prev prev{$type_display|escape:'html':'UTF-8'}{$id}{$cat_info.id_cat|intval}{$smarty.foreach.g_cat_info.iteration}"><i class="pe-7s-angle-left"></i></a>
							<a class="next next{$type_display|escape:'html':'UTF-8'}{$id}{$cat_info.id_cat|intval}{$smarty.foreach.g_cat_info.iteration}"><i class="pe-7s-angle-right"></i></a>
						</div> 
						{/if}
					</div>
					{if $group_cat.use_slider == 1}
