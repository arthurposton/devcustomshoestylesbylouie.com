...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row">
		...
		<!-- end left infos-->
		<!-- center infos -->
		<div class="pb-center-column {if !$content_only} col-xs-12 col-sm-6 col-md-6{else}col-xs-12 col-sm-6 col-md-6 {/if}">
			{if $product->online_only}
				<p class="online_only">{l s='Online only'}</p>
			{/if}
			<h1 itemprop="name">{$product->name|escape:'html':'UTF-8'}</h1>
			{capture name='displayProductListReviews'}{hook h='displayProductListReviews' }{/capture}
			{if $smarty.capture.displayProductListReviews}
				<div class="hook-reviews">
				{hook h='displayProductListReviews' }
				</div>
			{/if}
						...
						{if $product->description}
							<p class="buttons_bottom_block">
								<a href="javascript:{ldelim}{rdelim}" class="button">
									{l s='More details'}<i class="icon icon-angle-double-right"></i>
								</a>
							</p>
						{/if}
					{/if}
				...
				<div class="box-info-product">
					...
					<div class="box-cart-bottom ">
						...
						<p id="quantity_wanted_p"{if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
							<label for="quantity_wanted">{l s='Quanty:'}</label>
							<span class="qty-ii">
							<a href="#" data-field-qty="qty" class="btn btn-default button-minus product_quantity_down">
								<span>{l s='-'}<!-- <i class="icon-minus-square-o"></i> --></span>
							</a>
							<input  min="1" name="qty" id="quantity_wanted" class="text" value="{if isset($quantityBackup)}{$quantityBackup|intval}{else}{if $product->minimal_quantity > 1}{$product->minimal_quantity}{else}1{/if}{/if}" />
							
							<a href="#" data-field-qty="qty" class="btn btn-default button-plus product_quantity_up">
								<span>{l s='+'}<!-- i class="icon-plus-square-o"></i> --></span>
							</a>
							</span>
							...
							<div id="labCart" {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
								<p id="add_to_cart" class="buttons_bottom_block no-print">
									<button type="submit" name="Submit" class="exclusive">
										 <span><i class="icon icon-shopping-cart"></i>{if $content_only && (isset($product->customization_required) && $product->customization_required)}{l s='Customize'}{else}{l s='Add to cart'}{/if}</span>
									</button>
								</p>
							</div>
							{if !$content_only}
...
<div class="more-info">
	<div class="more-info-ii">
		<ul id="more_info_tabs" class="idTabs idTabsShort">
			{if $product->description}<li class="first"><a id="more_info_tab_more_info" href="#idTab1">{l s='More info'}</a></li>{/if}
										...
										<div  class="item">
											...
											<div class="left-block">
												<div class="product-image-container">
													{capture name='rotatorImg'}{hook h='rotatorImg' product=$accessory}{/capture}
												...
												<!-- {if isset($accessory.specific_prices) && $accessory.specific_prices && isset($accessory.specific_prices.reduction) && $accessory.specific_prices.reduction > 0}
													<div class="countdown" >
														{hook h='timecountdown' product=$accessory }  
														<span class="future_date_{$accessory.id_category_default}_{$accessory.id_product} id_countdown">  </span>
													</div>
												{/if} -->
												</div>
											</div>
