...
<div class="pos_featured_product block_product">
	<div class="container-inner">
		...
		<div class="pos-title">
			<h2>{$title}</h2>
			<p>{l s='Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. ' mod='posfeaturedproducts'}</p>
		</div>
		{/if}
		<div class="row">
