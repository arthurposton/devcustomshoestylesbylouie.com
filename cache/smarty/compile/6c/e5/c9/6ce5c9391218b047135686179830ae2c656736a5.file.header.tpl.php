<?php /* Smarty version Smarty-3.1.19, created on 2018-02-14 07:41:42
         compiled from "/home/sa7rru46ljhy/public_html/dev/prestashop/themes/lab_ethan_fashion11/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9987727905a83e8360408a1-24769875%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ce5c9391218b047135686179830ae2c656736a5' => 
    array (
      0 => '/home/sa7rru46ljhy/public_html/dev/prestashop/themes/lab_ethan_fashion11/header.tpl',
      1 => 1514779591,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9987727905a83e8360408a1-24769875',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a83e83612b605_56384791',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a83e83612b605_56384791')) {function content_5a83e83612b605_56384791($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/home/sa7rru46ljhy/public_html/dev/prestashop/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
rtl.css" type="text/css" media="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['media']->value, ENT_QUOTES, 'UTF-8', true);?>
" /> -->
...
"<?php }?> class="<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)!='index') {?>subpage<?php }?>  <?php if (isset($_smarty_tpl->tpl_vars['page_name']->value)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['geolocation_country']->value)&&$_smarty_tpl->tpl_vars['geolocation_country']->value) {?> <span class="bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['geolocation_country']->value, ENT_QUOTES, 'UTF-8', true);?>
		...
		<?php }?>
		<?php $_smarty_tpl->_capture_stack[0][] = array('labthemeoptions', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'labthemeoptions'),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
		...
		<?php if (Smarty::$_smarty_vars['capture']['labthemeoptions']) {?>
			<?php echo Smarty::$_smarty_vars['capture']['labthemeoptions'];?>
...
"<?php }?>/>
						...
						<div class="displayTop pull-right">																	
							<div class="center-mobile pull-right">
								<?php if (isset($_smarty_tpl->tpl_vars['HOOK_TOP']->value)) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_TOP']->value;?>
<?php }?>																
							</div>	
							<?php $_smarty_tpl->_capture_stack[0][] = array('labSearch', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'labSearch'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
							...
							<?php if (Smarty::$_smarty_vars['capture']['labSearch']) {?>
								<div class="labSearch pull-right">
									<?php echo Smarty::$_smarty_vars['capture']['labSearch'];?>

								</div>
							<?php }?>
						</div>	
						<?php $_smarty_tpl->_capture_stack[0][] = array('labmegamenu', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'labmegamenu'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
						...
						<?php if (Smarty::$_smarty_vars['capture']['labmegamenu']) {?>
							<div class="labmegamenu">							
								<div class="container">
									<?php echo Smarty::$_smarty_vars['capture']['labmegamenu'];?>
			...
			<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
			...
			<?php }?>
			<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
				<?php $_smarty_tpl->_capture_stack[0][] = array('smartBlog', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'smartBlog'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if (Smarty::$_smarty_vars['capture']['smartBlog']) {?>
					<div class="labSmartBlog">
						<div class="container">
							<?php echo Smarty::$_smarty_vars['capture']['smartBlog'];?>
			...
			<?php }?>
			<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
				<?php $_smarty_tpl->_capture_stack[0][] = array('blockPosition3', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'blockPosition3'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if (Smarty::$_smarty_vars['capture']['blockPosition3']) {?>
					<div class="blockPosition3 blockPosition">
						<?php echo Smarty::$_smarty_vars['capture']['blockPosition3'];?>

					</div>
				<?php }?>
			<?php }?>
			<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
				<?php $_smarty_tpl->_capture_stack[0][] = array('labtestimonials', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'labtestimonials'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if (Smarty::$_smarty_vars['capture']['labtestimonials']) {?>
					<div class="labtestimonials">
						<?php echo Smarty::$_smarty_vars['capture']['labtestimonials'];?>
			...
			<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
				<?php $_smarty_tpl->_capture_stack[0][] = array('blockPosition4', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'blockPosition4'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if (Smarty::$_smarty_vars['capture']['blockPosition4']) {?>
					<div class="blockPosition4 blockPosition">
						<div class="container">
							<div class="row">
								<?php echo Smarty::$_smarty_vars['capture']['blockPosition4'];?>
			...
			<?php }?>
			<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
				<?php $_smarty_tpl->_capture_stack[0][] = array('blockPosition5', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'blockPosition5'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if (Smarty::$_smarty_vars['capture']['blockPosition5']) {?>
					<div class="blockPosition5 blockPosition">
						<?php echo Smarty::$_smarty_vars['capture']['blockPosition5'];?>
			...
			<?php }?>
				...
				<?php if (htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true)=='index') {?>
					<?php $_smarty_tpl->_capture_stack[0][] = array('manufacturer', null, null); ob_start(); ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'manufacturer'),$_smarty_tpl);?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
					...
					<?php if (Smarty::$_smarty_vars['capture']['manufacturer']) {?>
						<div class="manufacturer">
							<div class="container">
								<div class="row">
									<?php echo Smarty::$_smarty_vars['capture']['manufacturer'];?>
