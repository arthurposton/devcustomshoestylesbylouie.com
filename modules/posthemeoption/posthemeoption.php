...
class posthemeoption extends Module
{
	...
	public function install()
	{
        ...
        $defaultfont1  = htmlentities("<link href='https://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet'> ");
       ...
       // Configuration::updateValue('TEXT_COLOR','#808080');
		...
		if (!parent::install()
		    ...
		    || !$this->registerHook('TopHeader')
            || !$this->registerHook('displayTop')
			|| $this->registerHook('layerCart') == false
