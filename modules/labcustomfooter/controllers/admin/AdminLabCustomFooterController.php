...
class AdminlabcustomfooterController extends ModuleAdminController {
    protected $id_banner;
    public function __construct() {
        $this->table = 'lab_staticfooter';
        $this->className = 'Staticfooter';
        $this->identifier = 'id_staticblock';
	    $this->bootstrap = true;
        $this->lang = true;
        $this->deleted = false;
...
//        echo "<pre>"; print_r($listSlideshows); die;
    ...
    public function renderForm() {
        ...
        $listHookModules = array(
			...
			array('hook_position'=>'blockFooter6'),
			array('hook_position'=>'blockFooter7'),
        );
        ...
        $this->fields_form = array(
            ...
            'input' => array(
               ...
               array(
                ...
                'desc' => $this->l('Choose the type of the Hooks <br> With new hooks as blockFooter1, block Footer2 , blockFooter3 ,blockFooter4, blockFooter5 must been  insert at tpl file. For example {hook h = "newHook"}')
            ),
