...
public function installDb(){
		...
		$sql =  "INSERT INTO `"._DB_PREFIX_."lab_staticfooter` (`id_staticblock`, `identify`, `hook_position`, `name_module`, `hook_module`, `order`, `insert_module`, `active`, `is_default`, `showhook`) VALUES
			('1','module-static','blockFooter1','blocknewsletter','displayFooter','0','1','0','0','1'),
			('2','html-static','blockFooter6','Chose Module','displayFooter','0','0','0','0','1'),
			('3','module-static','blockFooter6','blockcms','displayFooter','0','1','0','0','1'),
			('4','html-static','blockFooter6','Chose Module','displayFooter','0','0','0','0','1')							
			";
        $sql1 = "INSERT INTO `"._DB_PREFIX_."lab_staticfooter_lang` (`id_staticblock`, `id_lang`, `title`, `description`) VALUES
			('1','1','blocknewsletter',NULL),
			('1','2','blocknewsletter',NULL),
			('2','1','paypal','<div class=\"payment\"><a href=\"#\"><i class=\"icon icon-cc-mastercard\"> </i></a> <a href=\"#\"><i class=\"icon icon-cc-visa\"> </i></a> <a href=\"#\"><i class=\"icon icon-cc-discover\"> </i></a> <a href=\"#\"><i class=\"icon icon-credit-card\">  </i></a> <a href=\"#\"><i class=\"icon icon-cc-amex\">  </i></a></div>'),
			('2','2','paypal','<div class=\"payment\"><a href=\"#\"><i class=\"icon icon-cc-mastercard\"> </i></a> <a href=\"#\"><i class=\"icon icon-cc-visa\"> </i></a> <a href=\"#\"><i class=\"icon icon-cc-discover\"></i></a><a href=\"#\"><i class=\"icon icon-credit-card\"> </i></a>  <a href=\"#\"><i class=\"icon icon-cc-amex\">  </i></a></div>'),
			('3','1','blockcms',NULL),
			('3','2','blockcms',NULL),
			('4','1','Copyright','<div class=\"copyright \">Copyright @ 2017 All <a href=\"http://laberthemes.com/\">Erentheme. </a> rights reserved.</div>'),
			('4','2','copyright','<div class=\"copyright \">Copyright @ 2017 All <a href=\"http://laberthemes.com/\">Erentheme. </a> rights reserved.</div>'),
