...
class posfeaturedproducts extends Module {
	...
	public function install() {
        ...
        Configuration::updateValue($this->name . '_per_sm', 4);
        Configuration::updateValue($this->name . '_per_xs', 3);
        Configuration::updateValue($this->name . '_per_xxs', 2);
	...
	public function hookblockPosition1($params) {
        return $this->hookblockPosition2($params);
    }
